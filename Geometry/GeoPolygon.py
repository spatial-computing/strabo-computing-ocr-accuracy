...
class GeoPolygon(Polygon.Polygon):
    ...
    # def is_the_same_polygon(self, polygon2):
    ...
    def is_point_in_the_polygon(self, point):
        vertex = len(self.points)
        for i in range(1, vertex + 1, 1):
            p0 = self.points[i % 4]
    ...
    def get_overlap_polygon(self, polygon2):
        ...
        for point in polygon2.points:
            if self.is_point_in_the_polygon(point):
                intersection_points.append(point)

        for point in self.points:
            if polygon2.is_point_in_the_polygon(point) and point not in intersection_points:
                intersection_points.append(point)
...
if __name__ == '__main__':
    ...
    rect = GeoPolygon(coordinates, "")
    rect2 = GeoPolygon(coordinates, "")
    ...
    rect = GeoPolygon(coordinates2, "")
    rect2 = GeoPolygon(coordinates3, "")
